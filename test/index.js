...
suite(name, function () {
  ...
  test('support express sub-routes with Router that has more than one route', (done) => {
    const app = express()
    const router = express.Router()
    const oapi = openapi()
    ...
    router.get('/test', emptySchema, (req, res) => {
      res.status(204).send()
    })
    ...
    supertest(app)
      ...
      .expect(200, (err, res) => {
        ...
        SwaggerParser.validate(res.body, (err, api) => {
          ...
          assert(api.paths['/sub-route/test'])
          assert(api.paths['/sub-route/test'].get)
          assert(api.paths['/sub-route/endpoint'])
          assert(api.paths['/sub-route/endpoint'].get)
          assert(api.paths['/sub-route/endpoint'].get.responses[204])
          assert.strictEqual(
  ...
  test('support express nested sub-routes with Router that has more than one route', (done) => {
    const app = express()
    const router = express.Router()
    const subrouter = express.Router()
    const oapi = openapi()
    ...
    subrouter.get('/test', emptySchema, (req, res) => {
      res.status(204).send()
    })
    ...
    supertest(app)
      ...
      .expect(200, (err, res) => {
        ...
        SwaggerParser.validate(res.body, (err, api) => {
          ...
          assert(api.paths['/sub-route/sub-sub-route/endpoint'])
          assert(api.paths['/sub-route/sub-sub-route/endpoint'].get)
          assert(api.paths['/sub-route/sub-sub-route/test'])
          assert(api.paths['/sub-route/sub-sub-route/test'].get)
          assert(api.paths['/sub-route/sub-sub-route/endpoint'].get.responses[204])
          assert.strictEqual(
            api.paths['/sub-route/sub-sub-route/endpoint'].get.responses[204].description,
            'Successful response'
