...
- `options <object>`: Options object
  ...
  - The options object can also accept configuration parameters for Swagger. The full list of Swagger configuration options can be found here: https://swagger.io/docs/open-source-tools/swagger-ui/usage/configuration/
